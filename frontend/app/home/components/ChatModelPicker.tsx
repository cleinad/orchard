                  ...
                  {chatModels.map((model) => {
                    ...
                    return (
                      <button
                        ...
                        title={!model.available ? model.unavailableReason ?? 'Unavailable' : undefined}
                      >
                          ...
                          <span className="min-w-0">
                            <span className="flex min-w-0 items-center gap-1.5">
                              ...
                              {model.requiresPaidPlan ? (
                                <span className="rounded bg-foreground/[0.045] px-1.5 py-0.5 text-[10px] font-medium text-muted">
                                  Paid
                                </span>
                              ) : null}
                            </span>
                        ...
                        {!model.available ? (
                          <span className="ml-4 flex h-7 flex-shrink-0 items-center gap-1.5 rounded-full text-muted">
